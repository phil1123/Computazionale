function censusgui2(callbackarg)
%censusgui2 Try to predict the US population in the year 2010.
...
if nargin == 0
   ...
   shg
   clf reset
   set(gcf,'name','censusgui2','numbertitle','off')
   ...
   h.err = uicontrol('units','norm','pos',[.20 .65 .20 .05], ...
           ...
           'string','error estimates','callback','censusgui2([])');
   set(gcf,'userdata',h);
...
% Provide error estimates for censusgui2
