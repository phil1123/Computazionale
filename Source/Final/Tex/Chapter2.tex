...
%Non so cosa vuoi mettere in questa sezione. Se intendi cancellarla basta togliere la subsection e eliminare il \newpage qui sotto. Dovrebbe rimanere tutto bello
	...
	\begin{subfigure}
		{
			...
			%chiama la quarta figura square_transmission4.eps e decommenta la linea sopra
		}
	\end{subfigure}
	%
