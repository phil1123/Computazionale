...
%    normalized; then uniform metropolis is performed;
% depth sets the number of steps taken before the pseudorandom number 
% is returned.

narginchk(2,3)
if nargin == 2
	depth = 1;					% return pseudorandom at every step
end
